 ...
 *
 * Key fixes:
 * - Proper coordinate offset calculations relative to layer buffer
 * - Clip area intersection with relative coordinates
 * - Correct block_offset_x/y, pic_w/pic_h from draw buffer header
